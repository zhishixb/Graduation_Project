...
class DisciplineKeywordValidator:
    ...
    _DEFAULT_BLACKLIST: Dict[str, List[str]] = {
        "工学": ["护士", "临床医生", "律师", "教师", "会计", "医药", "心理咨询", "舞蹈", "编剧", "记者"],
        "医学": ["Java", "编程", "建筑", "土木", "律师", "会计", "销售", "直播", "剪辑"],
        "法学": ["Java", "编程", "护士", "临床医生", "建筑", "土木", "会计", "直播", "剪辑"],
        "文学": ["Java", "计算机", "编程", "手术", "医药", "律师", "会计", "建筑", "土木"],
        "哲学": ["Java", "计算机", "编程", "电路", "临床医生", "医药", "会计", "建筑", "土木"],
        "经济学": ["Java", "计算机", "编程", "手术", "临床医生", "护士", "建筑", "土木", "律师"],
        "管理学": ["Java", "计算机", "编程", "手术", "临床医生", "护士", "建筑", "土木"],
        "教育学": ["Java", "编程", "手术", "临床医生", "护士", "建筑", "土木", "律师", "会计"],
        "历史学": ["Java", "计算机", "编程", "手术", "临床医生", "护士", "建筑", "土木", "会计", "销售"],
        "理学": ["Java", "编程", "手术", "临床医生", "护士", "律师", "会计", "直播"],
        "农学": ["Java", "编程", "手术", "临床医生", "护士", "律师", "会计", "建筑", "土木"],
        "艺术学": ["Java", "计算机", "编程", "手术", "临床医生", "护士", "律师", "会计", "建筑", "土木"],
    }
