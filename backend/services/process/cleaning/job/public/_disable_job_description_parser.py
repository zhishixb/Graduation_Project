...
if __name__ == "__main__":
    jd_text = """
岗位职责：
1、	有丰富的短视频内容策划经验，能精准把握品牌定位及目标受众，结合市场热点与行业趋势，独立撰写逻辑清晰、创意十足的短视频脚本，明确短视频主题、分镜、镜头语言等核心元素，或配合团队进行脚本创作及优化。
2、	负责短视频的拍摄，协调现场人员把控进度与质量，做好拍摄试光、道具准备、取景或造景等准备工作，确保画面质量和构图符合要求。
3、	负责进行视频剪辑及后期包装，包括素材筛选、镜头拼接、节奏把控、字幕包装、音效添加等，灵活运用剪辑技巧提升视频观赏性，确保成片质量达标；实时关注行业动态，提升剪辑创意和技术水平。
4、	管理并维护新媒体账号，提高粉丝互动率和活跃度，定期收集并分析数据，优化内容策略。
5、	领导交办的其他工作任务。
任职要求：
1.	本科以上学历，影视制作、摄影、传媒、动画相关专业毕业。
2.	有3年新媒体创作经验，熟悉制造业、新能源、光伏、消费电子等领域者优先。
3.	具备一定剪辑和特效能力和较高的影视艺术、画面鉴赏能力，拥有丰富的灯光、取景经验，熟练运用Sony、Cannon、DJI、智云、影石等拍摄设备；同时具备策划、统筹、拍摄、制作能力者更佳。
4.	熟练应用PR/AE/达芬奇/剪映/PS等后期制作常用软件，能熟练使用C4D、Keyshot 等三维软件更佳。
5.	熟悉视频号、抖音、小红书等主流平台运营机制，能根据需求进行合理投流，每日监控各平台数据（阅读量、完播率、涨粉量、转化链路等），提炼运营痛点并优化内容方向、发布节奏；擅长直播策划者加分。
6.	有独立制作的能力和不断创新的意识，思维活跃，注重团队合作。
"""
