...
if __name__ == "__main__":
    jd_text = """
    岗位职责：
    1. 负责后端服务架构设计与开发，使用 Java Spring Cloud 体系；
    2. 参与高并发系统优化，熟悉 Redis 缓存策略及 MySQL 分库分表；
    3. 协助团队进行代码审查，具备良好的沟通能力和抗压能力；
    4. 有 K8s 容器化部署经验者优先。

    任职要求：
    1. 本科及以上学历，计算机相关专业；
    2. 精通 Python 或 Go 语言，熟悉 Linux 环境开发；
    3. 熟练使用 Git, Jenkins, Docker 等 DevOps 工具；
    4. 责任心强，具有团队合作精神。
    """
